...
a persistence unit "java-learningPersistenceUnit" which uses the JakartaEE default database.
...
In case you don't want to use JSF, simply delete this file and "src/main/webapp/beans.xml" and "src/main/java/org/learning/Jsf23Activator.java"
==========================

Testing:
This sample is prepared for running unit tests with the Arquillian framework.

The configuration can be found in "java-learning/pom.xml":
...
artifacts ("java-learning-ejb.jar" and "java-learning-web.war") are already built. You can build
